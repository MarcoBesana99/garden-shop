...
@section('content')
    ...
    <div class="bg-white position-relative">
        <div class="container p-4">
            ...
            <div class="row">
                <div class="col-12">
                    <h3 class="mb-3">{{ __('Privacy Policy') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Personal data storage and processing') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Data storage, alteration, and removal') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Processing of visiting technical data') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Children’s personal information') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Cookies processing') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Processing of personal data by other services') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Links to other websites') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Changes to the privacy policy') }}</h3 class="mb-3">
                    ...
                    <h3 class="mb-3">{{ __('Feedback and final clauses') }}</h3 class="mb-3">
